...
public class AVLTree<K extends Comparable<K>> implements AVLTreeADT<K> {
    ...
    private BSTNode<K> leftRotate(BSTNode<K> n) {
		...
		calHeight(P);
//        System.out.println(G.key.toString()+" "+P.key.toString());
        return P;
    }
    /**
...
//               avlTree.insert(insertItem);
//            }
//  
//            System.out.println(avlTree.print());
//            System.out.println(avlTree.checkForBalancedTree());
//        } catch (Exception e) {
...
//			}
//            // System.out.println(avlTree.print());
//			System.out.println(avlTree.root.getKey());
//			System.out.println(avlTree.root.getHeight());
//			avlTree.delete(10000);
//            for(int i = 9999; i >= 10; i--){
//				avlTree.delete(i);
//				if(avlTree.checkForBalancedTree()&&avlTree.checkForBinarySearchTree());
